function addToList(){
  ...
  $.ajax({
    url:'controller/sponsorController.php?isExistsApprover',
    type:'GET',
    cache:'false',
    data:{
...
function addApprover(id){
  load_in();
  $.ajax({
    url:'controller/sponsorController.php?addApprover',
    type:'POST',
    cache:'false',
    data:{
      'id_employee' : id
...
function confirmRemove(id, name)
{
  swal({
    ...
    load_in();
    $.ajax({
      url:'controller/sponsorController.php?removeApprover',
      type:'POST',
      cache:'false',
      data:{
        'id' : id
...
function setActive(id){
  $.ajax({
    url:'controller/sponsorController.php?setActiveApprover',
    type:'POST',
    cache:'false',
    data:{
      'id' : id
...
function disActive(id){
  $.ajax({
    url:'controller/sponsorController.php?disActiveApprover',
    type:'POST',
    cache:'false',
    data:{
      'id' : id
...
function clearFilter(){
  ...
  $.get('controller/sponsorController.php?clearFilter', function(){
    window.location.href = 'index.php?content=sponsor_approver';
  });
}
