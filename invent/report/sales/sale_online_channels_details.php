...
<div class="row">
  ...
  <div class="col-sm-2  padding-5">
    ...
    <input type="text" class="form-control input-sm text-center pd-box" id="txt-pd-from" placeholder="เริ่มต้น" />
  </div>

  <div class="col-sm-2 padding-5">
    <label class="display-block not-show">End</label>
    <input type="text" class="form-control input-sm text-center pd-box" id="txt-pd-to" placeholder="สิ้นสุด" />
  </div>
...
<table class="table table-striped table-bordered">
  ...
  {{#if nodata}}
    <tr>
      <td colspan="10" class="text-center">--ไม่พบรายการตามเงื่อนไขที่กำหนด--</td>
    </tr>
  {{else}}
    {{#each this}}
        ...
        <tr class="font-size-12">
          ...
          <td class="middle text-center">{{payment}}</td>
...
<script src="script/report/sale/sale_online_channels_details.js"></script>
