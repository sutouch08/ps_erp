...
<?php
	...
	$where = "WHERE ap.doc_type = 'SP-BUDGET' ";
  ...
  $paginator->display($get_rows, 'index.php?content=sponsor_approver');
...
<script src="script/sponsor_approver/sponsor_approver.js"></script>
